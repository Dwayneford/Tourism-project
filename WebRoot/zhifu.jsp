...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main" align="center">
		...
		<form name=alipayment action="http://localhost:8080/zhuji/alipay.trade.page.pay.jsp" method=post
			target="_blank">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center;">立即支付</button>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDout_trade_no").value ="<%=session.getAttribute("dindan_NO")%>";
		document.getElementById("WIDsubject").value = "旅游";
		
		<% 
		 String price = "";
		if(session.getAttribute("dindanzongjia").toString() != null){
		price =session.getAttribute("dindanzongjia").toString(); 
